...
public class foodManager {
    ...
    private static double[] getPercentages(HashMap<Date, Integer> foodIDs) {
    ...
    private static HashMap<Date, Integer> getFoodIDs(String username) {
        return dataAccess.UserProfile.database.getInstance().getFoodIDs(username);
    }

    private static HashMap<Date, Integer> getFoodIDs(String username, int days) {
